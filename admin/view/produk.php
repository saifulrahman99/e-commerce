                     ...
                     <?php $no = 1;
                        foreach ($select as $p) { ?>
                         <tr>
                             ...
                             <td><?= $p['kategori'] ?></td>
                             <td>
                                 <button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#editProduk<?= $p['id_produk'] ?>" onclick="show_edit_produk(<?= $p['id_produk'] ?>)">
                                     <i class="ti-pencil"></i>
                                     edit
                                 </button>
